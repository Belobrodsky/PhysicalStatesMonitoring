...
namespace Ipt
{
    internal static class UnsafeNativeMethods
    {
        ...
        /// <remarks>
        ///     Код в делфи: <code>function mb_connect(addr: PChar; outp: Integer): Integer; stdcall; external CWRAP;</code>
        /// </remarks>
        ...
        /// <remarks>
        ///     Код в делфи:
        ///     <code>function mb_rd_holding_registers(mb_saddr: Integer; mb_qregs: Integer; p: PChar): Integer; stdcall; external CWRAP;</code>
        /// </remarks>
        [DllImport("mbcli.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
